...
include('../../bussiness/zonacorporal.php');
...
if ($_POST){
    if (isset($_POST['btnGuardar'])){
        ...
        $rpta = $objData->Registrar($Id, $IdEmpresa, $IdCentro, $txtNombre, $chkMaquina, $chkMedida, $urlFoto, $idusuario);
    ...
    elseif (isset($_POST['btnEliminar'])) {
        ...
        $hdIdzonacorporal = $_POST['hdIdzonacorporal'];
        
        $rpta = $objData->EliminarStepByStep($hdIdzonacorporal, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
