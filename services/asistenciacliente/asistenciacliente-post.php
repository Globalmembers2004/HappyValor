...
if ($_POST){
    ...
    require '../../bussiness/clasecliente.php';
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $ddlServicio = (isset($_POST['ddlServicio'])) ? $_POST['ddlServicio'] : '';

        $rpta = $objData->Registrar('0', $IdEmpresa, $IdCentro, $ddlServicio, $hdIdCliente, date('Y-m-d'), $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
