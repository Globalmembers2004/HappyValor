...
require '../../bussiness/evaluacioncliente.php';
...
$objData = new clsEvaluacioncliente();

$row = $objData->ListarDetalle($tipobusqueda, $IdEmpresa, $IdCentro, $IdCliente, $Id, $criterio, $pagina);
