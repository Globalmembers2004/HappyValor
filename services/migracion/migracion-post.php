...
if ($_POST){
    ...
    require '../../bussiness/migracion.php';
    ...
    elseif (isset($_POST['btnEliminar'])) {
        ...
        $hdIdmigracion = $_POST['hdIdmigracion'];

        $rpta = $objData->EliminarStepByStep($hdIdmigracion, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
