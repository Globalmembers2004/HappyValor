...
if ($_POST){
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $txtMembresia = $_POST['txtMembresia'];
        $txtDias = $_POST['txtDias'];
        $txtVencimiento = $_POST['txtVencimiento'];
        $rpta = $objData->Registrar($hdIdPrimary, $IdEmpresa, $IdCentro, $txtMembresia, $txtNombre, $txtDias, $txtVencimiento, $txtPrecio, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
