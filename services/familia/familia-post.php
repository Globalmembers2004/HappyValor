...
if ($_POST){
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $chkEditable = isset($_POST['chkEditable']) ? 1 : 0;
   
        $rpta = $objData->Registrar($hdIdPrimary, $IdEmpresa, $IdCentro, $txtCodigoStart, $ddlTipoFamilia, $txtNombre, $chkEditable, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
