...
if ($_POST){
    ...
    if (isset($_POST['btnGuardar'])){
        ...
        $rpta = $objData->Registrar($hdIdPrimary, $IdEmpresa, $IdCentro, $txtCodigo, $txtNombre, $idusuario, $rpta, $titulomsje, $contenidomsje);
    }
