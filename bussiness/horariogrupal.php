...
class clshorariogrupal {
	...
	function Registrar($idhorariogrupal, $idempresa, $idcentro, $rutina, $instructor, $Ambiente, $dia, $horaInicio, $horaFinal, $aforo, $minutos, $idusuario, &$rpta, &$titulomsje, &$contenidomsje)
	{
		$bd = $this->objData;
		$sp_name = 'pa_horariogrupal_registrar';
		$result = $bd->exec_sp_iud($sp_name, array($idhorariogrupal, $idempresa, $idcentro, $rutina, $instructor, $Ambiente, $dia, $horaInicio, $horaFinal, $aforo, $minutos, $idusuario), '@rpta, @titulomsje, @contenidomensaje');
