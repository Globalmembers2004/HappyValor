...
function navigateInPage (alink) {
    ...
    if (idmenu != 'none') {
	    if (typeof iframeDocument.ListarOpcionesDropdown !== 'undefined')
	        iframeDocument.ListarOpcionesDropdown(idmenu);
    };
    ...
    if (submodulo != 'none') {
	    if (typeof iframeDocument.navigateSubSite !== 'undefined')
	        iframeDocument.navigateSubSite(submodulo, $(alink).text());
    };
}
