...
function MostrarDatos () {
    $.ajax({
        ...
        success: function (data) {
            ...
            if (countdata > 0) {
                while (i < countdata) {
                    strhtml += '<li class="mdl-list__item dato pos-rel" data-id="' + data[i].tm_idmoneda + '">';
                    
                    strhtml += '<input name="chkItem[]" type="checkbox" class="oculto" value="' + data[i].tm_idmoneda + '" />';

                    strhtml += '<span class="mdl-list__item-primary-content">' + data[i].tm_nombre + ' (' + data[i].tm_simbolo + ')</span>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.length > 0) {
                        ...
                        $('#chkDefault')[0].checked = data[0].tm_default == '1' ? true : false;
