            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.length > 0){
                        ...
                        $('#ddlTipoEquipo').val(data[0].ta_tipo_equipo);
                        ...
                        ListarAmbientes_Combo(data[0].tm_idambiente);
...
function ListarAmbientes_Combo (idambiente_default) {
    $.ajax({
        type: 'GET',
        ...
        success: function(data){
            ...
            if (countdata > 0) {
                while (i < countdata){
                    var _selected = idambiente_default == data[i].tm_idambiente ? ' selected' : '';
                    strhtml += '<option' + _selected + ' value="' + data[i].tm_idambiente + '">' + data[i].tm_nombre + '</option>';
                    ++i;
                };
            };

            $('#ddlAmbiente').html(strhtml);
        },
