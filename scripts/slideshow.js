var CHESLIDESHOW = (function () {
	...
	function animateSlides (newMode, callback) {
	...
	function animate (slide, callback) {
		var i = 0;
	...
	return {
		nextSlide: function (callback) {
			animateSlides('next', callback);
		},
		prevSlide: function (callback) {
			animateSlides('prev', callback);
		}
	};
})();