            ...
            <div class="scrollbarra padding20">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                            ...
                            <select id="ddlCenCos" name="ddlCenCos" style="width: 100%;" class="browser-default">
                            </select>
                    </div>                  
                    <div class="col-sm-12">            
                            <label class="active" for="ddlCtaCtb"><?php $translate->__('Cuenta Contable'); ?></label>
                            <select id="ddlCtaCtb" name="ddlCtaCtb" style="width: 100%;" class="browser-default">
                            </select>
                    </div>
                </div>
            </div>
