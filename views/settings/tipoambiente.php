    ...
    <div id="modalRegistro" class="modal-example-content expand-phone">
        <div class="modal-example-header no-padding mdl-layout--fixed-header">
            <header class="mdl-layout__header pink darken">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Tipos de ambiente</span>
                </div>
            </header>
        ...
        <div class="modal-example-body">
            ...
            <div class="scrollbarra padding20">
                ...
                <div class="row">
                    <p>
                      <input type="checkbox" class="filled-in" id="chkGrupal" name="chkGrupal" checked value="1" />
                      <label for="chkGrupal"><?php $translate->__('¿Es grupal?'); ?></label>
                    </p>
                </div>
            </div>
        </div>
