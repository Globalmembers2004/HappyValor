        ...
        <div class="modal-example-header no-padding mdl-layout--fixed-header">
            <header class="mdl-layout__header light-blue darken-2">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Cuenta Contable</span>
                </div>
            </header>
            ...
            <div class="scrollbarra padding20">
                <div class="row no-margin">
                    <div class="input-field">
                        <input id="txtCodigo" name="txtCodigo" type="text" placeholder="Ingrese código" />
                        <label for="txtCodigo"><?php $translate->__('Descripción'); ?></label>
                    </div>
                </div>
