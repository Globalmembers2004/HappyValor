    ...
    <div class="page-region">
        <div id="pnlListado" class="inner-page">
            <h1 class="title-window">
                <?php $translate->__('Programaci&oacute;n de productos'); ?>
            </h1>
            ...
            success: function(data){
                ...
                if (count > 0){
                    while (i < count){
                        ...
                        iSButtonUp = $("<button type=\"button\" class=\"up bg-green white-text\"></button>");
                        iSButtonUp.html('+');
                        iSButtonDown = $("<button type=\"button\" class=\"down bg-red white-text\"></button>");
                        iSButtonDown.html('-');
