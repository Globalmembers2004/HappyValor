...
<form id="form1" name="form1" method="post">
		    ...
		    <div class="divContent">
		    	<div class="detalleComercio container-details">
					<div class="headerPedido">
						<ul>
							<li class="colProducto"><a href="#"><h4 class="white-text"><?php $translate->__('Art&iacute;culos'); ?></h4></a></li>
							<li class="colPrecio"><a href="#"><h4 class="white-text"><?php $translate->__('Precio'); ?></h4></a></li>
							<li class="colCantidad"><a href="#"><h4 class="white-text"><?php $translate->__('Cantidad'); ?></h4></a></li>
							<li class="colSubTotal"><a href="#"><h4 class="white-text"><?php $translate->__('Importe'); ?></h4></a></li>
						</ul>
					</div>
	...
	<div id="pnlCategoria" class="slide-options">
		<div id="lstCategorias" class="list-options">
			<h2 class="white-text"><?php $translate->__('Categor&iacute;as'); ?></h2>
			<ul>
				<li><a href="#" class="active" rel="0"><h3 class="white-text"><?php $translate->__('Todos'); ?></h3></a></li>
			</ul>
		</div>
		<div id="lstSubCategorias" class="list-options">
			<h2 class="white-text"><?php $translate->__('Sub-Categor&iacute;as'); ?></h2>
			<ul>
				<li><a href="#" class="active" rel="0"><h3 class="white-text"><?php $translate->__('Todos'); ?></h3></a></li>
			</ul>
		</div>
	        ...
	        success: function(data){
	            ...
	            if (countDatos > 0){
	            	while(i < countDatos){
			            ...
			            strContent += '<h1 class="white-text">' + datos[i].tm_codigo + '</h1>';
			            strContent += '</div></div>';
        ...
        if (count > 0){
			...
			$.ajax({
		        ...
		        success: function(data){
		        	...
		        	tile.hide();
		        	$strContent = '<div class="tile-content"><div class="text-right padding10 ntp"><h3 class="white-text">';
					$strContent += strMesas;
		...
		$.ajax({
	        ...
	        success: function(data){
	            ...
	            while(i < countDatos){
                    ...
                    content = $('<h3 class="white-text"></h3>')
