                    ...
                    <div class="cell colspan6 all-height body-on-phone no-footer mdl-shadow--4dp">
                        <div class="scrollbarra padding20">
                            <div class="input-field">
                                <input class="validate" id="txtCodigo" name="txtCodigo" type="text" placeholder="Ingrese Codigo" />
                                <label for="txtCodigo"><?php $translate->__('Codigo'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtTipo" name="txtTipo" type="text" placeholder="Ingrese Tipo de Cliente" />
                                <label for="txtTipo"><?php $translate->__('Tipo de Cliente'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtDocIdentidad" name="txtDocIdentidad" type="text" placeholder="Ingrese Documento de identidad" />
                                <label for="txtDocIdentidad"><?php $translate->__('Documento de identidad'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtRuc" name="txtRuc" type="text" placeholder="Ingrese RUC" />
                                <label for="txtRuc"><?php $translate->__('RUC'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtDescripcion" name="txtDescripcion" type="text" placeholder="Ingrese Descripción" />
                                <label for="txtDescripcion"><?php $translate->__('Descripción'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtDireccion" name="txtDireccion" type="text" placeholder="Ingrese Dirección" />
                                <label for="txtDireccion"><?php $translate->__('Dirección'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtTelefono" name="txtTelefono" type="text" placeholder="Ingrese teléfono" />
                                <label for="txtTelefono"><?php $translate->__('Teléfono'); ?></label>
                            </div>                            
                        </div>
                    </div>
                </div>
