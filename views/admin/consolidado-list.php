        ...
        <div id="pnlListado" class="demo-layout-waterfall mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header mdl-layout__header light-green --waterfall">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Ventas Consolidadas</span>
                ...
                <div class="row all-height pos-rel form-photo no-margin">
                    <div class="cell colspan6 all-height body-on-phone no-footer mdl-shadow--4dp">
                        <div class="scrollbarra padding20">
                            ...
                            <div class="input-field">
                                <input class="validate" id="txtImporte" name="txtImporte" type="text" placeholder="Ingrese Importe Máximo" />
                                <label for="txtImporte"><?php $translate->__('Importe Máximo para separar'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtSubdiario" name="txtSubdiario" type="text" placeholder="Ingrese Subdiario" />
                                <label for="txtSubdiario"><?php $translate->__('Subdiario'); ?></label>
                            </div>
