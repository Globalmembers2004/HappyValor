        ...
        <div id="pnlListado" class="demo-layout-waterfall mdl-layout mdl-js-layout mdl-layout--fixed-header">
            <header class="mdl-layout__header mdl-layout__header light-green --waterfall">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title">Enlaces contables</span>
                    ...
                    <div class="cell colspan6 all-height body-on-phone no-footer mdl-shadow--4dp">
                        <div class="scrollbarra padding20">
                            <div class="input-field">
                                <input class="validate" id="txtLocal" name="txtLocal" type="text" placeholder="Ingrese Local" />
                                <label for="txtLocal"><?php $translate->__('Local'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCuenta_12" name="txtCuenta_12" type="text" placeholder="Ingrese cuenta Clientes" />
                                <label for="txtCuenta_12"><?php $translate->__('Cuenta Clientes'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCuenta_40" name="txtCuenta_40" type="text" placeholder="Ingrese cuenta Impuestos" />
                                <label for="txtCuenta_40"><?php $translate->__('Cuenta Impuestos'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCuenta_Facturas" name="txtCuenta_Facturas" type="text" placeholder="Ingrese cuenta Facturas" />
                                <label for="txtCuenta_Facturas"><?php $translate->__('Cuenta Facturas'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCuentaBoletas" name="txtCuentaBoletas" type="text" placeholder="Ingrese cuenta Boletas" />
                                <label for="txtCuentaBoletas"><?php $translate->__('Cuenta Boletas'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCentroCosto" name="txtCentroCosto" type="text" placeholder="Ingrese Centro de Costo" />
                                <label for="txtCentroCosto"><?php $translate->__('Centro de Costo'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtNombreLocal" name="txtNombreLocal" type="text" placeholder="Ingrese nombre de Local" />
                                <label for="txtNombreLocal"><?php $translate->__('Nombre de Local'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtSerie" name="txtSerie" type="text" placeholder="Ingrese serie" />
                                <label for="txtSerie"><?php $translate->__('Serie Local'); ?></label>
                            </div>
                            <div class="input-field">
                                <input class="validate" id="txtCodigo" name="txtCodigo" type="text" placeholder="Ingrese Código Local" />
                                <label for="txtCodigo"><?php $translate->__('Código Local'); ?></label>
                            </div>                            
                        </div>
                    </div>
                </div>
